...
class WorkerController {
	...
	var places: [Location] = [
		Location(name: "Chili's", address: "123 Avocado Ave, Fresno, CA, 93650", image: UIImage(named: "Chili's")!, duration: nil),
		Location(name: "Texas Roadhouse", address: "555 Barbeque Blvd, Austin, TX", image: UIImage(named: "Texas Roadhouse")!, duration: nil),
		Location(name: "Christopher's Steak House", address: "10 W 100 S, Salt Lake City, Utah, 84101", image: UIImage(named: "Christopher's Steak House")!, duration: nil),
		Location(name: "Takashi Sushi Restaurant", address: "456 Sashimi Street, Utica, NY, 12121", image: UIImage(named: "Takashi")!, duration: nil),
		Location(name: "Red Iguana", address: "200 S North Temple, Salt Lake City, Utah, 84101", image: UIImage(named: "Red Iguana")!, duration: nil),
	]
	...
	init() {
		...
		Worker(name: "Sonya Nichols", locations: [places[2]], rating: "4.9/5", tips: [Transaction(amount: nil, date: nil, location: nil)], tagline: "Donuts make me go nuts!", image: UIImage(named: "Sonya Nichols")!),
		Worker(name: "Sal Fiefia", locations: [places[0]], rating: "3.5/5", tips: [Transaction(amount: nil, date: nil, location: nil)], tagline: "Order the grilled chicken breast with honey mustard!", image: UIImage(named: "Sal Fiefia")!)
		]
	}
}
